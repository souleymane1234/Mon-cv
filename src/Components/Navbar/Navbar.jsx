        ...
        <>
            <Box id='navbar' bg={useColorModeValue('gray.100', 'gray.900')} px={4}>
                <Flex h={16} alignItems={'center'} justifyContent={'space-between'}>
                    <Box><img style={{ height: '80px', cursor: 'pointer' }} className='logo' src={logo} alt="logo"
                    ...
                    <HStack spacing={8} alignItems={'center'}>
                        <HStack
                            ...
                            <Link px={2} py={1} rounded={'md'} _hover={{ textDecoration: 'none', bg: 'gray.200' }} to={"/"}>Accueil</Link>
                        </HStack>
                        <HStack
                            as={'nav'}
                            spacing={4}
                            display={{ base: 'none', md: 'flex' }}>
                            <Link px={2} py={1} rounded={'md'} _hover={{ textDecoration: 'none', bg: 'gray.200' }} to={"Modeles"}>Nos modeles</Link>
                        </HStack>
