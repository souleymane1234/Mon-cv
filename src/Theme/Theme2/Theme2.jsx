                ...
                <section className='bottom-part d-flex mt-3'>
                    <section className='partition-1'>
                        <Box>
                            ...
                            <Box className='mt-3'>
                                <Heading fontSize='md' className='my-2'>Téléphone</Heading>
                                <Text fontSize={'sm'}>{phone}</Text>
                                <Heading fontSize='md' className='my-2'>E-mail</Heading>
                                <Text fontSize={'sm'}>{email}</Text>
                                <Heading fontSize='md' className='my-2'>Adresse</Heading>
                                <Text width={'190px'} fontSize={'sm'}>{address}</Text>
                            </Box>
                        </Box>
                        <Box className='mt-5'>
                            <Heading fontSize='2xl' className='my-2'>Compétences</Heading>
                            <Box className='mt-3'>
                                {
                    ...
                    <section className='partition-2'>
                        ...
                        <Box id='education-area'>
                            <Heading fontSize='2xl' className='my-2'>Formation</Heading>
                            {
...

                        {
                            !checkProj &&
                            <Box id='project-area'>
                                <Heading fontSize='2xl' className='mt-4'>Expérience personnelle</Heading>
                                {
                        ...
                        }
                        {
                            ...
                            <Box id='experience-area'>
                                <Heading fontSize='2xl' className='mt-4'>Expérience professionnelle</Heading>
                                {
                        ...
                        }
                        {
                            !checkAward &&
                            <Box id='award-area'>
                                <Heading fontSize='2xl' className='mt-4'>Loisirs</Heading>
                                <Box className='mt-1'>
                                    {
